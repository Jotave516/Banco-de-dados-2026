...
-- Qual o valor da maior e de menor mensalidade?
	select count(matricula) from aluno;
-- Qual o valor da maior e da menor mensalidade?
	select max(mensalidade) as 'Maior mensalidade',min(mensalidade) as 'Menor mensalidade' from aluno;
    
-- Qual o nome do aluno mais novo?
-- Qual a média de vagas ofertadas?
-- Quantos cursos não tem coordenador?
-- Qual faturamento com as mensalidades pagas?
